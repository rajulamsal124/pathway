...
export default function Notifications({ activeTab }: any) {
        ...
        <div className="row">
          <div className="col-12">
            ...
            <p className="text-14 lh-13 mt-5">
              Select push and email notifications you would like to receive
            </p>
          </div>
        </div>
          ...
          <div className="pt-30">
            <div className="row y-gap-20 justify-between">
              <div className="col-auto">
                ...
                <p className="text-14 lh-13 mt-5">
                  Notify me about activity from the profiles I am subscribed to
                </p>
              </div>
              <div className="col-auto">
